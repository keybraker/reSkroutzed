...
export class DarkModeHandler {
  ...
  public createDarkModeToggle(): HTMLDivElement {
    ...
    button.addEventListener('mouseover', () => document.body.classList.add('dark-mode-hover'));
    button.addEventListener('mouseout', () => document.body.classList.remove('dark-mode-hover'));
