...
function updateDisplayText(toggleSponsoredButton, visible, isProduct = true) {
  if (visible) {
    toggleSponsoredButton.classList.remove(
      isProduct ? "flagger-toggle-product-active" : "flagger-toggle-active"
    );
  } else {
...
function createSponsoredIndicatorButton(isProduct = true) {
  ...
  updateDisplayText(toggleSponsoredButton, visible, isProduct);
