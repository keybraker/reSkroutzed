...
The price checker makes sure the amount displayed on the product is actually the lowest. For those that "Buy through skroutz" is worth more than buying through a store directly, they can easily select a price difference threshold and pick whether the comparison comes from BestPrice or Shopflix.
...
- Lowest price checker outside of _"Buy through Skroutz"_
  - Comparison source: BestPrice, or Shopflix (Greece only)
